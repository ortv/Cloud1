...
namespace Cloud1.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,OrderDate,ShipDate,DeliveryDate")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,OrderDate,ShipDate,DeliveryDate")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
